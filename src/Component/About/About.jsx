...
import { FaGithub, FaFacebook, FaTwitter, FaHtml5, FaCss3Alt, FaReact, FaVuejs, FaGitAlt   } from "react-icons/fa";
          ...
          <div className="unordered-lists">
            ...
            <div className="skill-social">
              ...
              <ul className='social' >
                ...
                <li><FaReact id='react' />React Js</li>      
                <li><SiNextdotjs id='next' />Next Js</li>      
                <li><FaVuejs id='Vue' />Vue Js</li>
                <li><SiRedux id='redux' />Redux Toolkit</li>
                <li><FaGitAlt   id='Git' />Git </li>
              </ul>
              <ul className='social' >
                ...
                <li className='aligning'><a target='_blank' href='https://github.com/NoorAmin2004'>
